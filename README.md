...
1. **LANCZOS Resize:** Standardizes the physical pixel footprint of the code.
2. **CLAHE:** Equalizes local shadows and highlights.
3. **Gaussian Blur:** Melts away PCB fiberglass textures and copper traces.
4. **Adaptive Thresholding:** Binarizes the image into pure black and white.
5. **Morphological Close & Dilate:** Fills hollow laser rings and connects scattered dot-peen dimples into solid L-patterns.
6. **Edge Wipe & Inversion:** Erases false shadows on the image borders and flips the code to black-on-white.
